...
import { AiOutlineClose, AiOutlineFileAdd, AiOutlineHome, AiOutlineNotification, AiOutlineOrderedList, AiOutlineSetting } from "react-icons/ai"
...
const Sidebar = () => {
    ...
    return (
        <div className="z-[1]">
            <div className={hidden ? "  absolute lg:hidden left-3 top-7 " : "  hidden lg:hidden    dark:bg-slate-600"}>
                <GiHamburgerMenu size={21} onClick={() => setHidden(false)} />
            </div>
            <div className="absolute top-0 lg:relative">
                <div className={hidden ? "bg-base-300  h-screen relative px-2 py-2  hidden  lg:block dark:bg-slate-600" : "bg-base-300 h-screen relative px-2 py-2  dark:bg-slate-600"}>
                    <div className="mt-2 ml-2 ">
                        ...
                        <AiOutlineClose onClick={() => setHidden(true)} className="absolute top-2 cursor-pointer p-1 right-2 lg:hidden" size={30} />
                    </div>

                    <div className="lg:mt-8 mt-3 list-none space-y-3 lg:space-y-5 " id="sidebar">
                        <NavLink to="/" className="flex p-1 px-6 items-center justify-between ">
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                                <AiOutlineHome />
                                <li>Home</li>
                            </div>
                            <div className="text-blue-300 text-xs lg:text-[1rem] mt-1  text-center">
                                <BsBoxArrowRight />
                            </div>
                        </NavLink>
                        <Link to="/dashboard" className="flex text-blue-400 px-6 py-1 items-center justify-between ">
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                                <MdOutlineDashboardCustomize />
                                <li>Dashoboard</li>
                            </div>
                            <div className="text-blue-300 text-md mt-1  text-center">
                                <BsBoxArrowRight />
                            </div>
                        </Link>

                        <NavLink to="/dashboard/notifications" className={({ isActive }) => isActive ? "flex px-6 py-1 gap-5 items-center justify-between bg-red-400" : "flex px-6 py-1 items-center gap-5 justify-between "}>
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                                <AiOutlineNotification />
                                <li>Notificatios</li>
                                <p className="bg-red-400 rounded-full w-5 h-5 text-white text-xs flex items-center justify-center">2</p>
                        ...
                        <NavLink to="/dashboard/order" className={({ isActive }) => isActive ? "flex px-6 py-1 items-center justify-between bg-red-400" : "flex px-6 py-1 items-center justify-between "}>
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                        ...
                        <NavLink to="/dashboard/services" className={({ isActive }) => isActive ? "flex px-6 py-1 items-center justify-between bg-red-400" : "flex px-6 py-1 items-center justify-between "}>
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                        ...
                        <NavLink to="/dashboard/add-service" className={({ isActive }) => isActive ? "flex px-6 py-1 items-center justify-between bg-red-400" : "flex px-6 py-1 items-center justify-between "}>
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                                <AiOutlineFileAdd />
                                <li>Add Services</li>
                            </div>
                        ...
                        <NavLink to="/dashboard/users" className={({ isActive }) => isActive ? "flex px-6 py-1 items-center justify-between bg-red-400" : "flex px-6 py-1 items-center justify-between "}>
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                                <FiUsers />
                                <li>Users</li>
                            </div>
                        ...
                        <NavLink onClick={handleLogOut} className="flex px-6 py-1 items-center justify-between">
                            <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-300">
                                <BiLogOut />
                                <li>Logout</li>
                            </div>
                            <div className="text-blue-300 text-md mt-1  text-center">
                        ...
                        <div className="absolute lg:bottom-10 bottom-4 lg:space-y-4 space-y-2">
                            <NavLink to="/dashboard/help" className={({ isActive }) => isActive ? "flex px-6 py-1 items-center justify-between bg-red-400" : "flex px-6 py-1 items-center justify-between "}>
                                <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                                    <BiHelpCircle />
                                    <li>Help</li>
                                </div>
                            ...
                            <NavLink to="/dashboard/settings" className={({ isActive }) => isActive ? "flex px-6 py-1 items-center justify-between bg-red-400" : "flex px-6 py-1 items-center justify-between "}>
                                <div className="flex items-center gap-2 text-xs lg:text-[1rem] font-semibold text-blue-400">
                                    <AiOutlineSetting />
                                    <li>Settings</li>
                                </div>
